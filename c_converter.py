...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        self.intro_label = Label(
            self, text='Welcome to the Real-Time Currency Converter', fg='blue', relief=tk.RAISED, borderwidth=3)
        self.intro_label.config(font=('Courier', 15, 'bold'))

        self.date_label = Label(
            self, text=f"1 GBP equals = {self.currency_converter.convert('GBP', 'USD',1)} USD \n Date: {self.currency_converter.data['date']}", relief=tk.GROOVE, borderwidth=5)
    ...
    # This perfom function will take user input and convert the amount into the desired currency
